...
import 'package:flutter_favorite_places_app/screens/map.dart';
...
class _LocationInputState extends State<LocationInput> {
  ...
  Future<void> _savePlace(double latitude, double longtitude) async {
    final url = Uri.parse(
        'https://maps.googleapis.com/maps/api/geocode/json?latlng=$latitude,$longtitude&key=BURADAAPIKEYOLMALIDIR');
